...
const DashProfile = () => {
  ...
  const uploadImage = async () => {
    ...
    uploadTask.on(
      ...
      (snapshot) => {
        ...
        //here toFixed method is used to eliminate the decimal points or to make rounded number
  ...
  const handleSubmit = async (e) => {
    //preventing default action if the event does not get explicitly handled.
    e.preventDefault()
